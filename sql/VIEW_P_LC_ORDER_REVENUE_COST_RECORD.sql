...
(
    SELECT
        ...
        , CUST.PHONE_NUM
        , ORDER_LINE_ID
        , SUBSTR(ORDER_LINE_ID, 1, INSTR(ORDER_LINE_ID, '-' ,-1)-1) AS ORDER_ID
        , SUBSTR(ORDER_LINE_ID, INSTR(ORDER_LINE_ID, '-' ,-1)+1, LENGTH(ORDER_LINE_ID)) AS ORDER_SN
        ...
        , BILLING_TYPE
        , CASE
            WHEN EXECUTION_RECORD_NUMBER = 'NA' THEN NULL
            ELSE EXECUTION_RECORD_NUMBER
            END AS EXECUTION_RECORD_NUM
        , FINA.DB
